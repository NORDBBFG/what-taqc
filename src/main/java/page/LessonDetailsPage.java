...
//    private static final String ABSENT_ICON_XPATH = "//*[contains(@href,'Absent')]";
    ...
    private static final String DIV_XPATH = "//div"; //TODO
    ...
    public String getMark(int number) {
        if (!tableContent.isEmpty()) {
            for (WebElement webElement : tableContent) {
                if (webElement.findElement(By.xpath(ID_XPATH)).getText().equalsIgnoreCase(""+number)) {
                    return webElement.findElement(By.xpath(MARK_XPATH+DIV_XPATH)).getText();
                }
            }
        }
        return null;
    ...
    public String getMark(String name) {
        return getPresentStudentsNameAndMark().get(name);
//        if (!tableContent.isEmpty()) {
//            for (WebElement webElement : tableContent) {
...
//        return null;
    ...
    public boolean getPresence(int number) {
        if (!tableContent.isEmpty()) {
            for (WebElement webElement : tableContent) {
                if (webElement.findElement(By.xpath(ID_XPATH)).getText().equalsIgnoreCase(""+number) &&
                        webElement.findElement(By.xpath(PRESENT_ICON_XPATH))!=null) {
                    return true;
                }
            }
        }
    ...
    public boolean getPresence(String name) {
        return getPresentStudentsNameAndMark().get(name)!=null;
//        if (!tableContent.isEmpty()) {
//            for (WebElement webElement : tableContent) {
//                if (webElement.findElement(By.xpath(NAME_XPATH)).getText().equalsIgnoreCase(name) &&
//                        webElement.findElement(By.xpath(PRESENT_ICON_XPATH))!=null) {
...
//        return false;
    ...
    public HashMap<String, String> getPresentStudentsNameAndMark() {
        HashMap<String, String> presentStudents = new HashMap<>();
        if (!tableContent.isEmpty()) {
            for (WebElement webElement : tableContent) {
                if (webElement.findElement(By.xpath(PRESENT_ICON_XPATH)) != null) {
                   presentStudents.put(webElement.findElement(By.xpath(NAME_XPATH)).getText(),
